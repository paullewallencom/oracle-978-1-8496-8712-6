...
# -------- -----------    ------------------  -------------------------------
# 1.0      15-MAY-2012    Andy Penver         Initial Version
#************************************************************************
#
#+------------------------------------------------------+
...
l_control_file_list="$FND_TOP/patch/115/import/aflvmlu.lct LU_XXHR_SOCIETY_LOV.ldt"
